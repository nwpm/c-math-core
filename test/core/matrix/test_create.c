...
void test_create_copy_rows_5_cols_1() { create_copy_checker(1, 5); }
void test_create_copy_rows_50_cols_50() { create_copy_checker(1, 5); }
...
void test_create_from_arr_rows_5_cols_1() { create_from_arr_checker(1, 5); }
void test_create_from_arr_rows_50_cols_50() { create_from_arr_checker(1, 5); }
void test_create_from_arr_rows_250_cols_50() { create_from_arr_checker(250, 50); }
void test_create_from_arr_rows_1000_cols_1000() { create_from_arr_checker(1000, 1000); }
