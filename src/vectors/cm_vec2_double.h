...
/* Operations */
CmVec2Code cm_vec2_double_sum(CmVec2Double *vec_a, const CmVec2Double *vec_b);
CmVec2Code cm_vec2_double_sub(CmVec2Double *vec_a, const CmVec2Double *vec_b);
CmVec2Code cm_vec2_double_scale(CmVec2Double *vec, double scale);

CmVec2Code cm_vec2_double_dot(const CmVec2Double *vec_a,
                              const CmVec2Double *vec_b, double *res);
CmVec2Code cm_vec2_double_angle(const CmVec2Double *vec_a, const CmVec2Double *vec_b, double *angle);

bool cm_vec2_double_is_null(const CmVec2Double* vec);
bool cm_vec2_double_is_equal(const CmVec2Double* vec_a, const CmVec2Double *vec_b);
...
CmVec2Double *cm_vec2_double_cross(const CmVec2Double *vec_a, const CmVec2Double *vec_b;


/* Norm */
double cm_vec2_double_norm(const CmVec2Double *vec);
double cm_vec2_double_norm_squared(const CmVec2Double *vec);
double cm_vec2_double_distance(const CmVec2Double* vec_a, const CmVec2Double* vec_b);

/* Normalize */
CmVec2Double *cm_vec2_double_normalize(const CmVec2Double *vec);

/* Project */
CmVec2Double *cm_vec2_double_project(const CmVec2Double* proj_from, const CmVec2Double * proj_to);

/* Reflect */
CmVec2Double *cm_vec2_double_reflect(const CmVec2Double* vec);

/* Lerp */
CmVec2Double *cm_vec2_double_lerp(const CmVec2Double* start, const CmVec2Double *end, double t);
